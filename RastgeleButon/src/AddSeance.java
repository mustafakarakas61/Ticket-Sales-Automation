		...
		btn_AddSeance.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (rdbtn0.isSelected()) {
					seance = rdbtn0.getText();
				}
				if (rdbtn1.isSelected()) {
					seance = rdbtn1.getText();
				}
				if (rdbtn2.isSelected()) {
					seance = rdbtn2.getText();
				}
				if (rdbtn3.isSelected()) {
					seance = rdbtn3.getText();
				}
				if (rdbtn4.isSelected()) {
					seance = rdbtn4.getText();
				}
				if (rdbtn5.isSelected()) {
					seance = rdbtn5.getText();
				}
				if (rdbtn6.isSelected()) {
					seance = rdbtn6.getText();
				}
				if (rdbtn7.isSelected()) {
					seance = rdbtn7.getText();
				}
				if (rdbtn8.isSelected()) {
					seance = rdbtn8.getText();
				}
				if (rdbtn9.isSelected()) {
					seance = rdbtn9.getText();
				}
				if (rdbtn10.isSelected()) {
					seance = rdbtn10.getText();
				}
				if (rdbtn11.isSelected()) {
					seance = rdbtn11.getText();
				}
