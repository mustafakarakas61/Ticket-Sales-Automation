		...
		btn_Register.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (txt_Name.getText().length()==0 
						...
						|| txt_TCNo.getText().length()==0
						||txt_mail.getText().length()==0
				...
				{
					JOptionPane.showMessageDialog(null, "Tekrar girdiðiniz þifre ile þifreniz uyuþmuyor.", "Mesaj", JOptionPane.ERROR_MESSAGE);
					passfld_p2.setText("");
				}
				 else if(!chckbx_Confirm.isSelected())
				 {
					...
					if (control) {
						...
						Metod_Helper.showMsg(txt_TCNo.getText()+" T.C. kimlik Numarasý daha önce sisteme kayýtlý.");
					}
		...
		passfld_p1.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent ke) {
				if (ke.getKeyChar() == ' '
					...
					if (passfld_p1.getText().length() <= 30 
							|| ke.getKeyCode() == KeyEvent.VK_BACK_SPACE
							|| ke.getKeyCode()==KeyEvent.VK_ENTER
							|| ke.getKeyCode()==KeyEvent.VK_SHIFT
							|| ke.getKeyCode()==KeyEvent.VK_CAPS_LOCK
		...
		passfld_p2.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent ke) {
				if (ke.getKeyChar() == ' '
					...
					if (passfld_p2.getText().length() <= 30 
							|| ke.getKeyCode() == KeyEvent.VK_BACK_SPACE
							|| ke.getKeyCode()==KeyEvent.VK_ENTER
							|| ke.getKeyCode()==KeyEvent.VK_SHIFT
							|| ke.getKeyCode()==KeyEvent.VK_CAPS_LOCK
