...
public class SeatSelectionTheater extends JFrame implements MouseListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SeatSelectionTheater frame = new SeatSelectionTheater();
	 ...
	 * Create the frame.
	 */
	public SeatSelectionTheater() {
		setResizable(false);
		setIconImage(Toolkit.getDefaultToolkit().getImage(SeatSelectionTheater.class.getResource("/Images/ticket.png")));
		...
		ImageIcon imageIcon2 = new ImageIcon(SeatSelectionTheater.class.getResource("/Images/SeatOn.png"));
		...
		ImageIcon imageIcon3 = new ImageIcon(SeatSelectionTheater.class.getResource("/Images/SeatSelect.png"));
		...
		btn_Confirm.setBounds(472, 525, 150, 40);
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (e.getButton() == 1) {
			if (!(s.isSeatSelect())) {
				ImageIcon imageIcon = new ImageIcon(SeatSelectionTheater.class.getResource("/Images/SeatSelect.png"));
